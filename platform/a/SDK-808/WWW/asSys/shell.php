...
<link rel="stylesheet" type="text/css" href="http://localhost:9808/k/incl/fonts.css">';
...
<span class="linkSlug"> >| b://www-old/what-am-i </span> <a href="#">GO!</a></div>

<div class="wwwExplorer_innerShell">
The World Wide Web (also known as <a href="www">WWW</a>, W3, or simply the Web)[2] is a public interconnected information system that enables content sharing over the Internet.[3] It facilitates access to documents and other web resources according to specific rules of the Hypertext Transfer Protocol (HTTP).[4]
