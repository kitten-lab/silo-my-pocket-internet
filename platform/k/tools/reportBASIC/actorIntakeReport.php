...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    ## TOOL SIG FILE
        $GLOBALS['TOOL_FUNC'] = "INTAKE A REPORT";
        $GLOBALS['TOOL_LOC'] = "reportBASIC";
        $GLOBALS['TOOL_NAME'] = "IntakeReport";
...
// TIME TO MAKE A CRATE AND AN ECHO!!!
//=============================================================================


$ROUTE__LINE = ROUTE('d', $SHADOW_PROD_TOGGLE);

 $ROUTE = $ROUTE__LINE . $GLOBALS['TOOL_LOC'] . '/' . $GLOBALS[$site]['SYS_SLUG']  . '/' . $GLOBALS[$site]['DOM_SLUG'] . '/';
